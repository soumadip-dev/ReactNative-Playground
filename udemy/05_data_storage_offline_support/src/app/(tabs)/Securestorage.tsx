...
const styles = StyleSheet.create({
  ...
  button: {
    ...
    alignItems: 'center',
    borderRadius: 8,
    backgroundColor: '#2563eb', // Accent action blue
  },

  buttonDanger: {
    backgroundColor: '#dc2626', // Distinct danger color for remove action
  },
  ...
  outputContainer: {
    ...
    marginTop: 28,
    borderRadius: 8,
    backgroundColor: '#030712', // Near-black terminal surface
    borderWidth: 1,
    borderColor: '#1e293b',
    overflow: 'hidden',
  },
  ...
  outputText: {
    color: '#22c55e', // Classic matrix terminal green
    fontSize: 13,
    fontFamily: 'Courier',
    lineHeight: 20,
  },
